...
import { news, whoToFollow } from '../util/static'
...
const style = {
  ...
  newsItemRight: `w-1/5 ml-6`,
  newsItemImage: `rounded-xl h-14 w-14 object-cover`,
  followAvatarContainer: `w-1/6`,
  followAvatar: `rounded-full h-[40px] w-[40px]`,
  profileDetails: `flex-1`,
  name: `font-bold pl-4`,
  handle: `text-[#8899a6] pl-4`,

  followButton: `bg-white text-black px-3 py-1 m-4 rounded-full  text-xs font-bold`,
}
